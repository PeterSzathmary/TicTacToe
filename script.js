...
for (
  let i = 0;
  i < window.document.getElementsByClassName("board").length;
  i++
) {
...
/**
 * Default background color of a span.
 */
let spanBackground = options[0].children[0].style.backgroundColor;
/**
 * Default color of a span.
 */
let spanColor = options[0].children[0].style.color;

//#region Option Styling
options.forEach(option => {
  option.children[0].addEventListener("mouseenter", () => {
    option.children[0].style.backgroundColor = "rgb(40, 40, 40)";
    option.children[0].style.color = "white";
    option.children[0].style.borderRadius = "10px";
  });

  option.children[0].addEventListener("mouseleave", () => {
    option.children[0].style.backgroundColor = spanBackground;
    option.children[0].style.color = spanColor;
  });
});
//#endregion
...
for (
  let i = 0;
  i < window.document.getElementById("background").children.length;
  i++
) {
  backgroundChildren.push(
    window.document.getElementById("background").children[i]
  );
}
    ...
    if (playerX && playerO === false) {
      for (let i = 0; i < squares2DArray.length; i++) {
        for (let j = 0; j < squares2DArray[i].length; j++) {
          if (
            mousePosX > squares2DArray[i][j].x &&
            mousePosX < squares2DArray[i][j].xRange &&
            mousePosY > squares2DArray[i][j].y &&
            mousePosY < squares2DArray[i][j].yRange
          ) {
            ctx.fillStyle = "black";
            ctx.font = `${center * 2 + center}px vampirFont`;
            ctx.fillText(
              "X",
              squares2DArray[i][j].x + center,
              squares2DArray[i][j].y + center * 3
            );
            ctx.stroke();
...
function victory() {
  ...
  for (let i = 0; i < squares2DArray.length; i++) {
    for (let j = 0; j <= squares2DArray[i].length - 5; j++) {
      if (
        squares2DArray[i][j + 0] === "1X" &&
        squares2DArray[i][j + 1] === "1X" &&
        squares2DArray[i][j + 2] === "1X" &&
        squares2DArray[i][j + 3] === "1X" &&
        squares2DArray[i][j + 4] === "1X"
      ) {
        /* player X */
        whoWon = "Player X Won!";
        return true;
      } else if (
        squares2DArray[i][j + 0] === "1O" &&
        squares2DArray[i][j + 1] === "1O" &&
        squares2DArray[i][j + 2] === "1O" &&
        squares2DArray[i][j + 3] === "1O" &&
        squares2DArray[i][j + 4] === "1O"
      ) {
        /* player O */
        whoWon = "Player O Won!";
        return true;
  ...
  for (let i = 0; i <= squares2DArray.length - 5; i++) {
    for (let j = 0; j < squares2DArray[i].length; j++) {
      if (
        squares2DArray[i + 0][j] === "1X" &&
        squares2DArray[i + 1][j] === "1X" &&
        squares2DArray[i + 2][j] === "1X" &&
        squares2DArray[i + 3][j] === "1X" &&
        squares2DArray[i + 4][j] === "1X"
      ) {
        /* player X */
        whoWon = "Player X Won!";
        return true;
      } else if (
        squares2DArray[i + 0][j] === "1O" &&
        squares2DArray[i + 1][j] === "1O" &&
        squares2DArray[i + 2][j] === "1O" &&
        squares2DArray[i + 3][j] === "1O" &&
        squares2DArray[i + 4][j] === "1O"
      ) {
        /* player O */
        whoWon = "Player O Won!";
        return true;
  ...
  for (let i = 0; i <= squares2DArray.length - 5; i++) {
    for (let j = 0; j <= squares2DArray[i].length - 5; j++) {
      if (
        squares2DArray[i + 0][j + 4] === "1X" &&
        squares2DArray[i + 1][j + 3] === "1X" &&
        squares2DArray[i + 2][j + 2] === "1X" &&
        squares2DArray[i + 3][j + 1] === "1X" &&
        squares2DArray[i + 4][j + 0] === "1X"
      ) {
        /* player X */
        whoWon = "Player X Won!";
        return true;
      } else if (
        squares2DArray[i + 0][j + 4] === "1O" &&
        squares2DArray[i + 1][j + 3] === "1O" &&
        squares2DArray[i + 2][j + 2] === "1O" &&
        squares2DArray[i + 3][j + 1] === "1O" &&
        squares2DArray[i + 4][j + 0] === "1O"
      ) {
        /* player O */
        whoWon = "Player O Won!";
        return true;
  ...
  for (let i = 0; i <= squares2DArray.length - 5; i++) {
    for (let j = 0; j <= squares2DArray[i].length - 5; j++) {
      if (
        squares2DArray[i + 0][j + 0] === "1X" &&
        squares2DArray[i + 1][j + 1] === "1X" &&
        squares2DArray[i + 2][j + 2] === "1X" &&
        squares2DArray[i + 3][j + 3] === "1X" &&
        squares2DArray[i + 4][j + 4] === "1X"
      ) {
        /* player X */
        whoWon = "Player X Won!";
        return true;
      } else if (
        squares2DArray[i + 0][j + 0] === "1O" &&
        squares2DArray[i + 1][j + 1] === "1O" &&
        squares2DArray[i + 2][j + 2] === "1O" &&
        squares2DArray[i + 3][j + 3] === "1O" &&
        squares2DArray[i + 4][j + 4] === "1O"
      ) {
        /* player O */
        whoWon = "Player O Won!";
        return true;
